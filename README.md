...
<p align="center">
  <img src="https://files.catbox.moe/hwc7wy.jpg" alt="Thumbnail" />
</p>
...
await sock.sendMessage(jid, { 
    eventMessage: { 
        isCanceled: false, 
        name: "Hello World", 
        description: "GupongOfficial", 
        location: { 
            degreesLatitude: 0, 
            degreesLongitude: 0, 
            name: "rowrrrr" 
        }, 
        joinLink: "https://call.whatsapp.com/video/GupongOfficial", 
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        header: "Hello World",
        title: "Hello World",
        footer: "telegram: @GupongOfficial ",
        buttons: [
            {
                name: "cta_copy",
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                limited_time_offer: {            
                    ...
                    copy_code: "GupongOfficial",            
                    expiration_time: Date.now() * 999          
                },          
                bottom_sheet: {            
                    in_thread_buttons_limit: 2,            
                    divider_indices: [1, 2, 3, 4, 5, 999],            
                    list_title: "GupongOfficial",            
                    button_title: "GupongOfficial"          
                },          
                tap_target_configuration: {            
                    title: " X ",            
                    description: "bomboclard",            
                    canonical_url: "https://t.me/GupongOfficial",            
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/GupongOfficial",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/GupongOfficial",
                    merchant_url: "https://t.me/GupongOfficial"
                })
            }
        ]
    }
...
- Has 1 newsletter follow, only the developer's WhatsApp channel: [WhatsApp Channel](https://whatsapp.com/channel/0029Vb7lHDYKQuJPk8jYNc1W)
...
- **Telegram**: [Telegram Contact](https://t.me/GupongOfficial)
- **Channel WhatsApp**: [Channel WhatsApp](https://whatsapp.com/channel/0029Vb7lHDYKQuJPk8jYNc1W) 
